...
const NavSection = () => {
  ...
  return (
    <>
      <div className="h-screen overflow-hidden bg-svg-background bg-cover">  {/*Background Div*/}
        <div className="flex items-center justify-between md:px-10 lg:px-16">   {/*Parent Div*/}
          <div className="ml-10 mt-5">  {/*Image Div*/}
            <Image
              className="my-auto"
              src="/adisoft.svg"
              alt="Logo"
          ...
          <div className="mt-9 hidden text-lg md:block"> {/*Links Div*/}
          ...
          <div className="mr-10 mt-8 flex">  {/*Button Div*/}
            <button
        ...
        <div className="mt-5 border-b border-white"> </div> {/*Bottom Border Div*/}
        <div className="flex h-screen flex-col items-center justify-center ">  {/*Hero Section  Div*/}
          ...
          <div className="mt-8 flex flex-col gap-5 md:flex-row">  {/*Button Div*/}
            <button
              className="flex-shrink-0 rounded border-4 border-none bg-rgb-yellow px-9 py-2.5 text-sm text-rgb-green"
              type="button"
            >
              Pitch Now
            </button>
            <button
              className="flex-shrink-0 rounded border-4 border-none bg-white px-10 py-2.5 text-sm text-rgb-green"
              type="button"
            >
              Become an Investor
            </button>
